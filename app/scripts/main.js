...
$(window).load(function() {
	...
	function drawTimer(c, a) {
		...
		var skill = ['html', 'css', 'sass', 'js', 'jquery', 'ps', 'ai', 'ae', 'maya'];
	
		$('#pie-' + c).html('<div id="slice"' + (a > 5 ? 'class="gt50"' : '') + '><div class="pie"></div>' + (a > 5 ? '<div class="pie fill"></div>' : '') + '</div>' + '<div class="icon-skill icon-' + skill[c] + '"></div>');
		...
		// var endColor =  new $.Color('rgb(0,197,209)');
	}
